...
public class JDEditarUsuarioVista extends JDialog {
    ...
    public JDEditarUsuarioVista(Frame parent, boolean modal) {
        super(parent, "Modificar Registro de Personal", modal);
        ...
        BorderFactory.createLineBorder(new Color(226, 232, 240), 1), " Actualizar Credenciales ");
        ...
        panelForm.add(crearLabel("Nueva Clave:", fontTitulos)); 
        ...
        JLabel lblInfoTitle = new JLabel("Nota de seguridad:");
        lblInfoTitle.setFont(new Font("Segoe UI", Font.BOLD, 11));
        lblInfoTitle.setForeground(new Color(74, 85, 104));
        
        JLabel lblInfoDetalle = new JLabel("<html>Si digita una nueva clave, recuerde cumplir con las políticas (8 caracteres, MAYÚSCULA, número y símbolo).</html>");
        ...
        btnGuardar = configurarBoton("Actualizar", new Color(42, 157, 143), new Color(34, 128, 116), fontBotones);
