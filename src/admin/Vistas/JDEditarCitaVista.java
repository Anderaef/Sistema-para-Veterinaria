...
public class JDEditarCitaVista extends JDialog {

    public JTextField txtFecha, txtPaciente;
    public JComboBox<String> cbVeterinarios;
    public JButton btnCalendario;
    public JSpinner spnHora;   
    public JTextArea txtMotivo;
    public JButton btnGuardarCambios, btnCancelar;

    public JDEditarCitaVista(Frame parent, boolean modal) {
        super(parent, "Modificar Cita", modal);
        ...
        Font fontTextos = new Font("Segoe UI", Font.PLAIN, 13);
        ...
        ((TitledBorder)form.getBorder()).setBorder(BorderFactory.createCompoundBorder(
                ((TitledBorder)form.getBorder()).getBorder(), new EmptyBorder(15, 20, 15, 20)));

        Color colorBloqueado = new Color(237, 242, 247);

        txtPaciente = new JTextField();
        txtPaciente.setFont(fontTextos);
        txtPaciente.setEditable(false);
        txtPaciente.setBackground(colorBloqueado);
        txtPaciente.setForeground(new Color(113, 128, 150));
        txtPaciente.setBorder(new CompoundBorder(new LineBorder(new Color(203, 213, 224), 1), new EmptyBorder(5, 10, 5, 10)));
        ...
        JPanel panelFechaHora = new JPanel(new GridBagLayout());
        ...
        btnCalendario.setPreferredSize(new Dimension(35, 30));
        ...
        spnHora.setPreferredSize(new Dimension(80, 30)); 
        spnHora.setBorder(new CompoundBorder(new LineBorder(new Color(203, 213, 224), 1), new EmptyBorder(2, 5, 2, 5)));

        gbc.gridx = 0;
        gbc.weightx = 1.0;
        gbc.insets = new Insets(0, 0, 0, 10);
        panelFechaHora.add(pnlFecha, gbc);

        gbc.gridx = 1;
        gbc.weightx = 0.0;
        gbc.insets = new Insets(0, 0, 0, 0);
        panelFechaHora.add(spnHora, gbc);

        form.add(crearLabel("Paciente:", fontTitulos));
        form.add(txtPaciente);
        form.add(crearLabel("Nueva Fecha y Hora:", fontTitulos));
        form.add(panelFechaHora); 
        form.add(crearLabel("Médico Asignado:", fontTitulos));
        form.add(cbVeterinarios); 

        JPanel panelMotivo = new JPanel(new BorderLayout(0, 5));
        ...
        txtMotivo.setMargin(new Insets(5, 10, 5, 10));
        txtMotivo.setEditable(false);
        txtMotivo.setBackground(colorBloqueado);
        txtMotivo.setForeground(new Color(113, 128, 150));
        ...
        btnGuardarCambios = configurarBoton("Guardar Cambios", new Color(42, 157, 143), new Color(34, 128, 116), fontBotones);
    ...
    private void desplegarCalendarioGrafico(JTextField campoDestino) {
        ...
        lblMesAño.setFont(new Font("Segoe UI", Font.BOLD, 13));
